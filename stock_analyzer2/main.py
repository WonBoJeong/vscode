...
from modules import (
    Logger, ErrorHandler, DataManager, KoreanStockManager, 
    ChartManager, AnalysisEngine, InvestmentCalculator, CrashAnalyzer
)
from modules.utils import DataValidator, format_currency_auto
from modules.korean_stock_manager import show_korean_stock_search_dialog
from modules.data_manager import show_download_dialog
...
class BosPlanApp:
    ...
    def create_analysis_tab(self):
        ...
        try:
            ...
            for i, stock in enumerate(MY_STOCKS[:6]):
                row = i // 3
                col = i % 3
            ...
            tk.Label(left_panel, text="진입가:").pack(anchor=tk.W)
            tk.Entry(left_panel, textvariable=self.entry_price_var).pack(fill=tk.X, pady=(2, 8))
            
            tk.Label(left_panel, text="보유량:").pack(anchor=tk.W)
        ...
        try:
            ...
            info_text = tk.Label(info_frame, 
                               text=f"📈 {APP_NAME} 폭락장 대응 시스템\n\n" +
                                    ...
                                    "Analysis 탭에서 종목을 선택하고 포지션 정보를 입력한 후 분석하세요.",
    ...
    def download_data(self):
        ...
        try:
            ...
            if result and result['success']:
                ...
                self.chart_manager.update_chart(result['data'], symbol)
            else:
    ...
    def analyze_stock(self):
        ...
        try:
            ...
            if analysis_result:
                ...
                self.chart_manager.update_chart(data, symbol, entry_price, company_name)
                
                messagebox.showinfo("✅", f"'{symbol}' 분석이 완료되었습니다!")
            else:
...
권장사항: {risk_result['recommendation']}"""
    ...
    def analyze_crash_situation(self):
        ...
        try:
            ...
            crash_result = self.crash_analyzer.analyze_crash_situation(data, symbol, entry_price, position)
